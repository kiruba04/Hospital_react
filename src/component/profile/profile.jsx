...
const UserInformation = () => {
  ...
  const fetchAppointments = async (userId) => {
    try {
      const response = await axios.get(`${process.env.REACT_APP_API_URL}/api/appointments/${userId}`);
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.put(`${process.env.REACT_APP_API_URL}/api/user/${user._id}`, user, {
  ...
  const deleteappointment = async (appointmentId) => {
    try {
      await axios.delete(`${process.env.REACT_APP_API_URL}/api/appointment/delete/${appointmentId}`);
